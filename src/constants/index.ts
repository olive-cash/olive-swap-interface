...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [
      new Token(ChainId.MAINNET, '0x617724974218A18769020A70162165A539c07E8a', 18, 'OLIVE', 'OliveCash Token'),
      new Token(ChainId.MAINNET, '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', 18, 'WAVAX', 'Wrapped AVAX'),
    ],
    [BUSD, USDT],
    [DAI, USDT],
  ],
