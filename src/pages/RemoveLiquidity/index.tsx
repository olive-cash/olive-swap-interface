...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@olive-dev/avax-sdk'
import { Button, Flex, Text } from '@olive-dev/uikit'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WAVAX')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                            ...
                            >
                              {TranslateString(1190, 'Receive AVAX')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
